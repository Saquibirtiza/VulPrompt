...
file_list = ["chrome_-1457977271973356031.c", "chrome_-7422764464424760982.c", "debian_-7136186224744987223.c", "qemu_10f5a72f70862d299ddbdf226d6dc71fa4ae34dd.c", "qemu_f59df3f2354982ee0381b87d1ce561f1eb0ed505.c","FFmpeg_aeb59e839f97e88dd0b5f0b2a4422a9ee75321e5.c", "qemu_6546d0dba6c211c1a3eac1252a4f50a0c151a08a.c","qemu_b7a745dc33a18377bb4a8dfe54d1df01ea60bf66.c", "qemu_2ae39a113af311cb56a0c35b7f212dafcef15303.c","qemu_10eacda787ac9990dc22d4437b289200c819712c.c"]
...
def clean_gadget(gadget):
    ...
    # nor_code = cleaned_gadget
    # queue.put(cleaned_gadget)
...
def normalize(path):
    ...
    for setfolder in setfolderlist:
        ...
        for catefolder in catefolderlist:
            ...
            print(catefolder)
            if catefolder in file_list:
                os.environ['filename'] = str(filepath)
...
def pro_one_file(filepath):
    ...
    with open(filepath, "r") as file:
        ...
        # action_process = Process(target=clean_gadget, args=(org_code,))
